...
async fn main() {
    ...
    .route("/api/struct_by_dish/:id", get(get_struct_by_dish_id))
    .route("/api/add_dish", post(add_dish))
    .route("/api/update_dish", put(update_dish))
    .route("/api/cart_by_order/:id", get(get_cart_by_order_id))
    .route("/api/delete_dish", delete(delete_dish))
    .route("/api/order_by_user/:id", get(get_orders_by_user_id))
